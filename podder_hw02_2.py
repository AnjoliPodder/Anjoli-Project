...
print(x_coordinate(0, 0, 1., 1))
print(x_coordinate(1., 0, 1., 10.))
print(x_coordinate(10., 2., 0., 10.))


'''
PART II
Note: import math module to solve this problem
Implement a function df() which calculate a discount factor using continously compunded rate.
...
'''
PART V
In class we have disucssed comparison operator ==
...
i3 = i1
print('Integers i1 = %s i2 = %s' % (i1, i3), both_equal(i1, i3), i3 == i1)
